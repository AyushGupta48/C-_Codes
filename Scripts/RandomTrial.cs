...
public class RandomTrial : MonoBehaviour //This is the rng for mechatronic madness level 1 but I dont know how to change the name of the script without it breaking
{
    public Animator anim; //Variables for enemy and laser movement
    public Animator animlaser; //The lasers are png format because despite thousands of efforts of having an actual laser or at least a 3d object it did not work
